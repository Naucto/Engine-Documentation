...
section: editors
order: 2
description: The Map Editor lets you paint tile-based levels and backgrounds using
  the sprites you created in the Sprite Editor.
legacy_slugs:
...
To render the map in your game, call [[map.draw]] inside `_draw()`:
...
2.  **Flag your collision sprites** in the Sprite Editor -- for example, turn on bit `0` for solid tiles
...
See [[map.get]] and [[map.flag]] in the API reference for details.
