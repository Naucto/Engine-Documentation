...
![The console column of CODE](../editors/img/code-console.png "The transport under the screen: Play, Restart and Step, then the Auto switch; the Console under it is where --- HALTED --- appears.")
